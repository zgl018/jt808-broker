...
public class JT808Session {
	...
	public static JT808Session buildSession(Channel channel) {
		return buildSession(channel, null);
	}

	public static JT808Session buildSession(Channel channel, String phone) {
		JT808Session session = new JT808Session();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JT808Session other = (JT808Session) obj;
		if (id == null) {
			if (other.id != null)
				return false;

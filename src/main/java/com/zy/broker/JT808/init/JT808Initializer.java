...
import com.zy.broker.JT808.handler.ChatHeartbeatHandler;
...
public class JT808Initializer extends ChannelInitializer<Channel>{
    ...
    protected void initChannel(Channel channel) throws Exception {
        channel.pipeline()
                .addLast(new IdleStateHandler(TPMSConsts.tcp_client_idle_minutes, 0, 0, TimeUnit.MINUTES))
                .addLast(new ChatHeartbeatHandler())
